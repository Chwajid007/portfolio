  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-AAsecondary">10 mobile applications</span>,
        integrating MongoDB, and MySQL, and optimized CI/CD pipelines to reduce
        deployment times by 30%. Successfully launched{" "}
        <span className="text-AAsecondary">
          3 live applications on Google Play and Apple Store
        </span>
        . I am passionate about DevOps and cloud infrastructure, optimizing
        systems for peak performance and scalability
      </motion.h3>
      <motion.div
        initial={{ y: 10, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        ...
        className="mt-12"
      >
        <a href={"/wajid-ali.pdf"} target={"_blank"} rel="noreferrer">
